...
class Landing_CD(Buzon, ):
    ...
    def step_impl(self):
        ...
        assert Buzon.get_text(self,
                              "Titulo_Archivos_Recientes") == "Archivos recientes"  # COMPARO EL TEXT ARCHIVOS RECIENTES
    ...
    def step_impl(self):
        localizador = self.driver.find_element(By.XPATH,
                                               "/html/body/div[3]/div/div[2]/div[2]/app-amx-family-plan/div/app-member-list/div/app-member[2]/div/div[4]/button[2]")
        action = ActionChains(self.driver)
        action.move_to_element(localizador)
        # action.perform()
        time.sleep(3)
    ...
    @then("I click Wizard")
    def step_impl(self):
        Buzon.get_elements(self, "Wizard_BTN").click()
        time.sleep(2)

        self.Textos_Wizard = self.driver.find_elements(By.XPATH, "/html/body/div[3]/div/app-amx-files/app-wizard-popup/div[3]/div/div/div[1]/div/div[2]")
        self.count = 0

        for self.Wizard in self.Textos_Wizard:
    ...
    @step("I click Comenzar")
    def step_impl(self):
        Buzon.get_elements(self, "Wizard_BTN_Comenzar").click()
        time.sleep(2)
    ...
    def step_impl(self):
        self.Textos_Wizard = self.driver.find_elements(By.XPATH,
                                                       "/html/body/div[3]/div/app-amx-files/app-wizard-popup/div[3]/div/div/div[1]/div/div[2]")
        self.count = 0
    ...
    @then("I click Finalizar on the Menu Galeria button")
    def step_impl(self):
        self.Textos_Wizard = self.driver.find_elements(By.XPATH,
                                                       "/html/body/div[3]/div/app-amx-files/app-wizard-popup/div[3]/div/div/div[1]/div/div[2]")
        self.count = 0
    ...
    @then("I click Cerrar")
    def step_impl(self):
        Buzon.get_elements(self, "Wizard_BTN_Cerrar").click()
        time.sleep(3)
